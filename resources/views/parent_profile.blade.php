...
<body>
        ...
        <div class="card w-100">
          ...
          <div class="card-body p-2">
            <form id="formId" method="post" enctype="multipart/form-data" novalidate>
              ...
              <input onkeyup="setInputUppercase(event)" type="text" class="form-control form-control-sm" id="parent_name" name="parent_name" required />
              <div class="d-none invalid-feedback">
                Please provide full name.
              </div>
              <label for="parent_email" class="form-label">Email address</label>
              <input type="email" class="form-control form-control-sm" id="parent_email" name="parent_email" required />
              <div class="d-none invalid-feedback">
                Please provide email.
              </div>
              <label for="parent_password" class="form-label">Password</label>
              <input type="password" class="form-control form-control-sm" id="parent_password" name="parent_password" required />
              <div class="d-none invalid-feedback">
    ...
    function onGetProfile() {
      $.ajax({
				type: 'GET',
				url: '/parent/' + sessionStorage.getItem('user_id')
			}).then(function(data) {
				onSetForm('formId', data.parent);
			});
    }
